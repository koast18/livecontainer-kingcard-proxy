...
DOWNLOAD_URL="https://gh-proxy.com/https://github.com/${REPO}/releases/download/${TAG}/LiveProxyConsole-${VER}.ipa"

cat > AltStore/beta-source.json <<JSON
{
  "name": "LiveProxy 测试版源",
  "identifier": "com.liveproxy.source.beta",
  "sourceURL": "${SOURCE_URL}",
  "apps": [
    {
      "name": "LiveProxy 测试版控制台",
      "bundleIdentifier": "com.liveproxy.console.beta",
      "developerName": "koast18",
      "version": "${BETA_VER}",
      "versionDate": "${DATE}",
      "versionDescription": "LiveProxy 测试版控制台：perf/fix-dylib-lag 热路径性能修复。",
      "downloadURL": "${DOWNLOAD_URL}",
      "localizedDescription": "测试版控制台 IPA。首次打开会从 GitHub Release ${TAG} 自动下载对应的 LCProxyControl dylib。用于验证 dylib 注入后的性能修复。",
